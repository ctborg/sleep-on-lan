...
#define FirewallRuleName "Sleep on LAN UDP 9"
...
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""{#FirewallRuleName}"" protocol=UDP localport=9 >NUL 2>NUL"; StatusMsg: "Refreshing firewall rule..."; Flags: runhidden waituntilterminated
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall add rule name=""{#FirewallRuleName}"" dir=in action=allow protocol=UDP localport=9 >NUL"; StatusMsg: "Opening UDP port 9..."; Flags: runhidden waituntilterminated
...
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""{#FirewallRuleName}"" protocol=UDP localport=9 >NUL 2>NUL"; Flags: runhidden waituntilterminated; RunOnceId: "DeleteSleepOnLanFirewallRule"
